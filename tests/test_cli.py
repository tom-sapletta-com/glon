...
from klo.cli import parse_git_url, create_directory_structure, clone_repository
...
class TestCLIIntegration:
    ...
    @patch('klo.cli.clone_repository')
    @patch('klo.cli.create_directory_structure')
    @patch('klo.cli.parse_git_url')
